...
from isp.dataset.base_dataset import BaseImageDataset
from isp.env_runner.base_image_runner import BaseImageRunner
from isp.common.checkpoint_util import TopKCheckpointManager
from isp.common.json_logger import JsonLogger
from isp.common.pytorch_util import dict_apply, optimizer_to
from isp.model.diffusion.ema_model import EMAModel
from isp.model.common.lr_scheduler import get_scheduler

OmegaConf.register_new_resolver("eval", eval, replace=True)


class TrainISPWorkspace(BaseWorkspace):
...
def main(cfg):
    workspace = TrainISPWorkspace(cfg)
    workspace.run()
