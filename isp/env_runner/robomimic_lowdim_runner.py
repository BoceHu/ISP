...
from isp.gym_util.async_vector_env import AsyncVectorEnv

# from isp.gym_util.sync_vector_env import SyncVectorEnv
from isp.gym_util.multistep_wrapper import MultiStepWrapper
from isp.gym_util.video_recording_wrapper import (
    VideoRecordingWrapper,
    VideoRecorder,
)
from isp.model.common.rotation_transformer import RotationTransformer

from isp.policy.base_lowdim_policy import BaseLowdimPolicy
from isp.common.pytorch_util import dict_apply
from isp.env_runner.base_lowdim_runner import BaseLowdimRunner
from isp.env.robomimic.robomimic_lowdim_wrapper import RobomimicLowdimWrapper
    ...
    def __init__(
        ...
        def dummy_env_fn():
            robomimic_env = create_env(
                env_meta=env_meta, obs_keys=obs_keys, enable_render=False
            )
            return MultiStepWrapper(
                VideoRecordingWrapper(
                    RobomimicLowdimWrapper(
