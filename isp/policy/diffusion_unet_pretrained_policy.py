...
from isp.model.vision.multi_image_obs_encoder import MultiImageObsEncoder
from isp.model.vision.timm_obs_encoder import (
    TimmObsEncoder,
...
from isp.model.vision.rot_randomizer import RotRandomizer


class DiffusionUnetPretrainedPolicy(BaseImagePolicy):
    def __init__(
        self,
        shape_meta: dict,
        noise_scheduler: DDPMScheduler,
        obs_encoder: Union[MultiImageObsEncoder],
        horizon,
        n_action_steps,
        n_obs_steps,
    ...
    def predict_action(
        ...
        if self.obs_as_global_cond:
            ...
            if type(self.obs_encoder) not in [
                TimmObsEncoder,
                C8EquivariantTimmObsEncoder,
            ]:
