...
from isp.model.equi.equi_obs_encoder_so3 import ISPObsEnc
from isp.model.equi.equi_conditional_unet1d import EquiDiffusionUNet
from isp.model.vision.rot_randomizer import (
    RotRandomizer,
    RotRandomizerForPrediction,
)
from isp.model.equi.equi_group_sampling import EquiGroupSamplingIco
from isp.model.common.rotation_transformer import RotationTransformer


class ISPSO3Policy(BaseImagePolicy):
    def __init__(
        self,
        shape_meta: dict,
